function [ret_posdata, ret_negdata] = get_postive_examples(pos,...
...
try
    load([cachedir cls '_' dataset_fg '_' year '_pos_' num2str(w) '_' num2str(h) '_' num2str(offset)]);
catch
    ...
    save([cachedir cls '_' dataset_fg '_' year '_' num2str(w) '_' num2str(h) '_' num2str(offset)], 'ret_posdata', 'ret_negdata');
